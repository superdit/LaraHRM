      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar" style="overflow-y: scroll;">
          <ul class="nav nav-pills nav-stacked">
            ...
            <li @if( Request::segment(2) == 'employee') {{ 'class="active"' }} @endif><a href="{{URL::to('admin/employee')}}"><i class="fa fa-users"></i> &nbsp;Employee</a></li>
            <li @if( Request::segment(2) == 'employeesetting') {{ 'class="active"' }} @endif><a href="{{URL::to('admin/employeesetting/employmenttype')}}"><i class="fa fa-gears"></i> &nbsp;Emp. Setting</a></li>
            <li @if( Request::segment(2) == 'event') {{ 'class="active"' }} @endif><a href="{{URL::to('admin/event')}}"><i class="fa fa-calendar"></i> &nbsp;Event Calendar</a></li>
            
            <li><a href="javascript:void(0);" class="top-menu"><i class="fa fa-terminal"></i> &nbsp; Admin <i class="fa fa-toggle-down pull-right ico-toggle"></i></a></li>
            <ul class="nav nav-pills nav-stacked sub-menu">
                <li @if( Request::segment(2) == 'employeeleave') {{ 'class="active"' }} @endif><a href="{{URL::to('admin/employeeleave')}}">&nbsp;&nbsp;&nbsp;&nbsp;<small><i class="fa fa-sign-out"></i> &nbsp;Leave Type</small></a></li>
                <li @if( Request::segment(2) == 'department') {{ 'class="active"' }} @endif><a href="{{URL::to('admin/department')}}">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-hospital-o"></i><small>&nbsp; Departments</small></a></li>
                <li @if( Request::segment(2) == 'user') {{ 'class="active"' }} @endif><a href="{{URL::to('admin/user')}}">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-user"></i><small>&nbsp; Users</small></a></li>
            </ul>
          </ul>
        </div>
