...
//                                                }
                                ...
                                <table id="tbl-kpi-review" class="table table-striped table-hover">
                                  ...
                                  <tr>
                                      <td id="kpi_result_{{$kp->id}}">
                                          <input type="hidden" name="kpi_result_id[]" value="{{ $kp->id }}" />
                                          <strong>{{ $kp->kpi->name }}</strong>
                                      </td>
                                      <td>
<!--                                          <input type="hidden" name="weight[]" value="{{ $kp->default_weight }}"/>-->
                                      ...
                                      <td><input type="text" name="realization[]" class="form-control" @if($fail) value="{{ $input_values['realization'][$index] }}" @else value="{{ $kp->realization }}" @endif/></td>
<!--                                      <td id="td_{{$kp->id}}" class="text-right">
                                  ...
                                  <tr>
                                      ...
                                      <td colspan="3"><textarea rows="3" class="form-control" name="note[]">@if($fail) {{ $input_values['note'][$index] }} @else {{ $kp->note }} @endif</textarea></td>
                                  </tr>
                                  @endforeach
                                  </tbody>
                                </table>
