...
$(function() {
    ...
    $('.btn-contact-del').click(function() { 
        ...
        $('#btn-do-delete-contact').attr('href', '{{URL::to("admin/employeecontact/delete-from-employee")}}/'+{{$employee->id}}+'/'+tmp_id);
    });
...
<div class="modal fade" id="addContactModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        <form role="form" class="form-horizontal" action="{{URL::to('admin/employeecontact/add-to-employee')}}" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="editContactModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        <form role="form" class="form-horizontal" action="{{URL::to('admin/employeecontact/edit-from-employee')}}" method="post" enctype="multipart/form-data">
